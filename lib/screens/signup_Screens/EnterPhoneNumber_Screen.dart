...
class EnterPhoneNumberScreen extends StatefulWidget {
  static const routeName = '/doctor-enter-phone-number-screen';
              ...
              onPressed: () async {
                ...
                if (_userPhoneNumber.text.length != 10) {
                  ...
                  Provider.of<DoctorUserDetails>(context, listen: false)
                      .setDoctorMobileNumber(_userPhoneNumber);
