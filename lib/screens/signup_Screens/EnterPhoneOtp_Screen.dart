// ignore_for_file: unnecessary_this, use_key_in_widget_constructors, unused_field, prefer_final_fields, prefer_const_constructors, use_build_context_synchronously, deprecated_member_use, prefer_const_literals_to_create_immutables, unused_import, must_be_immutable, unused_local_variable
...
class EnterPhoneOtpScreen extends StatefulWidget {
  static const routeName = '/doctor-enter-phone-number-otp-screen';
...
class _EnterPhoneOtpScreenState extends State<EnterPhoneOtpScreen> {
  ...
  void initState() {
    ...
    _userPhoneNumber = Provider.of<DoctorUserDetails>(context, listen: false)
        .doctorMobileNumber;
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    child: Text(
                      isLangEnglish
                          ? "SMS with 6 digit code sent on"
                          : "6 अंक कोड एसएमएस भेजा गया",
                      style: TextStyle(
                        fontFamily: 'Roboto',
                ...
                Positioned(
                  ...
                  child: Container(
                    child: Text(
                      "+91 ${Provider.of<DoctorUserDetails>(context, listen: false).doctorMobileNumber.text}",
                      style: TextStyle(
                        fontFamily: 'Roboto',
                        fontWeight: FontWeight.w700,
                        fontSize: 18,
                  ...
                  child: Row(
                    ...
                    children: [
                      TextButton(
                        ...
                        child: Text(
                          isLangEnglish ? "Resend OTP" : "ओटीपी पुनः भेजें",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontFamily: 'Roboto',
                            fontWeight: FontWeight.w500,
                ...
                // Container(
                //   padding: EdgeInsets.only(top: 0.65 * screenHeight),
                //   alignment: Alignment.topCenter,
                //   child: Align(
                //     child: Container(
  ...
  Future<void> _checkForAuthentication(
    ...
    await _auth.verifyPhoneNumber(
      ...
      codeSent: (verificationId, resendingToken) async {
        print(isLangEnglish ? 'otp sent' : 'ओटीपी भेजा');
      ...
      if (authCredential.user != null) {
        ...
        if (Provider.of<DoctorAuthDetails>(context, listen: false)
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                isLangEnglish ? "Signing In..." : "साइनइन करने में...",
              ),
            ),
          );
          ...
          Provider.of<DoctorUserDetails>(context, listen: false)
              .upLoadNewDoctorPersonalInformation(
            context,
            authCredential,
          );
        }
