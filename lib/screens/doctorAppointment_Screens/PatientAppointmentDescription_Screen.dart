...
class PatientAppointmentDescriptionScreen extends StatefulWidget {
  static const routeName = '/doctor-patient-appointment-description-screen';
...
class _PatientAppointmentDescriptionScreenState
  ...
  void initState() {
    ...
    String aptDate =
        "${widget.tokenInfo.bookedTokenDate.day}-${widget.tokenInfo.bookedTokenDate.month}-${widget.tokenInfo.bookedTokenDate.year}";
    String aptTime = widget.tokenInfo.bookedTokenTime.toString();
    String refLink =
        "PatientReportsAndPrescriptionsDetails/${widget.tokenInfo.patient_personalUniqueIdentificationId}/${widget.tokenInfo.doctor_personalUniqueIdentificationId}/${widget.tokenInfo.registeredTokenId}/${aptDate}/${aptTime}/PatientPreviousPrescription";

    String refLinkForDoctorPrescription =
        "PatientReportsAndPrescriptionsDetails/${widget.tokenInfo.patient_personalUniqueIdentificationId}/${widget.tokenInfo.doctor_personalUniqueIdentificationId}/${widget.tokenInfo.registeredTokenId}/${aptDate}/${aptTime}/DoctorGivenPrescription";

    futureFiles = FirebaseStorage.instance.ref('/${refLink}').listAll();
        ...
        children: <Widget>[
                                          ...
                                          child: Container(
                                            child: Text.rich(
                                              TextSpan(
                                                children: <TextSpan>[
                                                  TextSpan(
                                                    text: widget.tokenInfo
                                                                .patient_Age ==
                                                            0
                                                        ? "NA"
                                                        : "${widget.tokenInfo.patient_Age}",
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 30,
                                                ...
                                                children: <TextSpan>[
                                                  TextSpan(
                                                    text: widget.tokenInfo
                                                            ...
                                                            ""
                                                        ? "NA"
                                                        : "${widget.tokenInfo.patient_BloodGroup}",
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 30,
                                                ...
                                                children: <TextSpan>[
                                                  TextSpan(
                                                    text: widget.tokenInfo
                                                            ...
                                                            0
                                                        ? "NA"
                                                        : "${widget.tokenInfo.patient_Height}",
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: widget.tokenInfo
                                                                  .patient_Height ==
                                                              0
                                                          ? 30
                                                          : 20,
                                                ...
                                                children: <TextSpan>[
                                                  TextSpan(
                                                    text: widget.tokenInfo
                                                            ...
                                                            0
                                                        ? "NA"
                                                        : "${widget.tokenInfo.patient_Weight}",
                                                    style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 30,
          ...
          futureFilesDocPres.toString() == null
              ? Align(
                  child: Container(
                    ...
                    child: Text(
                      isLangEnglish
                          ? "No prescription uploaded from your end"
                          : "आपकी ओर से कोई प्रिस्क्रिप्शन अपलोड नहीं किया गया",
                      style: TextStyle(
                        fontStyle: FontStyle.italic,
                      ),
                    ),
                  ...
                  child: Container(
                    ...
                    child: Text(
                      isLangEnglish
                          ...
                          : "रोगी द्वारा कोई पिछला प्रिस्क्रिप्शन अपलोड नहीं किया गया",
                      style: TextStyle(
                        fontStyle: FontStyle.italic,
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Text(
                          widget.tokenInfo.patientAilmentDescription == ""
                              ? isLangEnglish
                                  ? "▶️ No aliment mentioned by the patient"
                                  : "▶️ मरीज द्वारा उल्लेखित कोई भी आहार नहीं"
                              : "▶️ ${widget.tokenInfo.patientAilmentDescription}",
                        ),
                      ),
                    ),
                  ),
          ...
          Align(
            child: Container(
              ...
              width: screenWidth * 0.9,
              child: Text(
                widget.tokenInfo.patient_Medication == ""
                    ? isLangEnglish
                        ? "▶️ No previous medication available"
                        : "▶️ कोई पिछली दवा उपलब्ध नहीं है"
                    : "▶️ ${widget.tokenInfo.patient_Medication}",
              ),
            ),
          ),
          Align(
            ...
            child: Container(
              ...
              child: Text(
                widget.tokenInfo.patient_Medication == ""
                    ...
                    : "▶️ ${widget.tokenInfo.patient_Injuries}",
              ),
            ),
          ),
          Align(
            ...
            child: Container(
              ...
              child: Text(
                widget.tokenInfo.patient_Medication == ""
                    ...
                    : "▶️ ${widget.tokenInfo.patient_Surgeries}",
              ),
            ),
          ),
          SizedBox(
