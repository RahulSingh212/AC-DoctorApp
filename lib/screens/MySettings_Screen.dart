...
class MySettingsScreen extends StatefulWidget {
  static const routeName = '/doctor-my-settings-screen';
...
class _MySettingsScreenState extends State<MySettingsScreen> {
  ...
  String playstoreLink = "https://play.google.com/store/apps/details?id=com.aurigaCare.auriga_doctor";
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () async {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => DoctorShareApplicationScreen(
                  3,
                ),
              ),
            );
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => DoctorCustomerCareScreen(
                  3,
                ),
              ),
            );
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => DoctorManageAccountScreen(
                  3,
                ),
              ),
            );
            ...
            onPressed: () {
              setState(() {
                if (popVal == false) {
                  ...
                  _auth.signOut();
                  Navigator.of(context).pushNamedAndRemoveUntil(
                      SelectLanguageScreenDoctor.routeName, (route) => false);
                }
              });
            },
          ),
  ...
  Future<void> _seclectReadingLanguageType(
    ...
    String str2 =
        isLangEnglish ? "Set Language to Hindi" : "भाषा को हिंदी में सेट करें";
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: <Widget>[
          IconButton(
            ...
            iconSize: 50,
            tooltip: isLangEnglish ? 'OK' : "ठीक है",
            color: Colors.brown,
            onPressed: () {
              setState(() {
                if (popVal == false) {
