...
import '../../providers/doctorPatient_details.dart';
import '../../providers/doctorUser_details.dart';
import 'PreviousPatientDetail_Screen.dart';

class MyPatients_RecentSectionTab extends StatefulWidget {
  static const routeName = '/doctor-my-patients-recent-section-tab';

  @override
  State<MyPatients_RecentSectionTab> createState() => _MyPatients_RecentSectionTabState();
}

class _MyPatients_RecentSectionTabState extends State<MyPatients_RecentSectionTab> {
        ...
        child: Column(
          children: [
            ...
            Provider.of<DoctorPatientDetails>(context, listen: false)
                ...
                : Align(
                    child: Container(
                      height: max(screenHeight, screenWidth) * 0.725,
                          ...
                          TextSpan(
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                ...
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: min(screenWidth, screenHeight) * 0.0525,
                      ...
                      Container(
                        child: Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(
                                text: isLangEnglish ? 'Last Appointment booked on:\n' : "अंतिम अपॉइंटमेंट बुक किया गया था:\n",
                                style: TextStyle(
                              ...
                              TextSpan(
                                ...
                                style: TextStyle(
                                  fontSize: min(screenWidth, screenHeight) * 0.035,
                                ),
                              ),
                              TextSpan(
                                text: '${DateFormat.yMMMd().format(prevPatientInfo.patient_LastBookedAppointmentDate).toString()}',
                                style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  color: Color.fromRGBO(114, 114, 114, 1),
                                  fontSize: min(screenWidth, screenHeight) * 0.0475,
                                  overflow: TextOverflow.ellipsis,
                                ),
                              ),
                              TextSpan(
                              ...
                              TextSpan(
                                text: '${prevPatientInfo.patient_LastBookedAppointmentTime.format(context)}',
                                style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  color: Color.fromRGBO(114, 114, 114, 1),
                                  fontSize: min(screenWidth, screenHeight) * 0.0475,
